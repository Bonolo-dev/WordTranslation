...
class ModeOneImplementationTest {
    ...
    void translator() {
        ...
        //When
        ModeOneImplementation modeOneImplementation = new ModeOneImplementation();
        String translatedTest =modeOneImplementation.translator(testData, dictionary );
